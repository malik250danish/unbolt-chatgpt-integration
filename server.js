...
const BASE_URL = "https://unbolt-chatgpt-integration-production.up.railway.app";
    ...
    services: [
      {
        ...
        base_price: 79.99,
        description:
          "Emergency car lockout service - we'll get you back in your vehicle",
      },
      {
        id: "key_programming",
...
app.post("/v1/quotes/:id/reprice", (req, res) => {
  console.log(
    "📞 POST /v1/quotes/:id/reprice called:",
    req.params.id,
    req.body
  );
